            ...
            <div class="productset flex-fill" style="box-shadow: 0 20px 50px rgba(0, 0, 0, 0.1); border: 1px solid rgba(236, 236, 236, 0.933); border-radius: 8px">
                ...
                <div class="d-flex justify-content-center align-items-center mb-3">
                    ...
                    @else
                        ...
                        <button type="button" class="btn btn-primary btn-sm me-2" data-bs-toggle="modal" data-bs-target="#alertModal{{$item->id}}">
...
@foreach ($books as $item)
<!-- Modal -->
<div class="modal fade" id="alertModal{{$item->id}}" tabindex="-1" aria-labelledby="alertModalLabel{{$item->id}}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="alertModalLabel{{$item->id}}">Alert</h5>
