        ...
        <div class="card-body">
            <div class="table-top">
                ...
                <div class="wordset">
                    <ul>
                        <li>
                            <a href="{{ route('exportBooksPDF', ['search' => request()->query('search')]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="pdf"><img src="{{ asset('assets/img/icons/pdf.svg') }}" alt="img"></a>
                        </li>
                        <li>
